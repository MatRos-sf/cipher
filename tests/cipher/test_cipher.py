...
class TestCipher:
    ...
    @pytest.mark.parametrize("value", list(ascii_lowercase))
    def test_response_when_user_response_is_invalid_then_should_return_tuple_of_none(self, value, mocker, capsys):
    ...
    def test_some_when_user_response_is_1_or_2_then_should_execute_func(self, value, mocker):
    ...
    def test_some_when_user_response_is_from_3_to_6_then_should_execute_and_return_int_and_none(self, value, mocker):
